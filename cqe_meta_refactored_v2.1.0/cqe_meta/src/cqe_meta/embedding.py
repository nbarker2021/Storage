...
class EmbeddingStore:
    ...
    def save(self, receipts: List[EmbeddingReceipt]) -> int:
    ...
    def load(self) -> List[EmbeddingReceipt]:
        ...
        with open(self.path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                receipts.append(EmbeddingReceipt.from_dict(data))
        
        return receipts
    
    def append(self, receipt: EmbeddingReceipt) -> None:
